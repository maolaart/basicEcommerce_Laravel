            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title text-dark font-weight-bold">Data Slider</h5>
                            ...
                            <div class="col-md-12">
                                <form class="form-slider">
                                    <div class="form-group">
                                        <label class="text-dark font-weight-bold">Nama Slider</label>
                                        <input required type="text" class="form-control" name="nama_slider"
